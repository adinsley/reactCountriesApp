...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountriesBox = React.createClass({
	  ...
	  updateCurrentCountry: function updateCurrentCountry(country) {
	    this.setState({ currentCountry: country });
	  },

	  updateCurrentRegion: function updateCurrentRegion(region) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(RegionSelect, { regions: this.getRegions(), updateCurrentRegion: this.updateCurrentRegion }),
	      React.createElement(CountriesSelect, { countries: this.filterCountries(), updateCurrentCountry: this.updateCurrentCountry }),
	      React.createElement(CountryDisplay, { currentCountry: this.state.currentCountry, countries: this.state.countries, updateCurrentCountry: this.updateCurrentCountry })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountriesSelect = React.createClass({
	  ...
	  createOption: function createOption(country, index) {
	    return React.createElement(
	      'option',
	      { id: country.name, value: country.alpha3Code },
	      country.name
	    );
	  },
	    ...
	    if (this.props.currentCountry) {
	      return React.createElement(
	        ...
	        React.createElement(
	          'p',
	          null,
	          this.props.currentCountry.capital
	        ),
	        React.createElement(
	          'p',
	          null,
	          this.props.currentCountry.currencies
	        ),
	        React.createElement(
	          'p',
	          null,
	          Number(this.props.currentCountry.population).toLocaleString()
	        ),
	        React.createElement(BorderingCountries, { borderers: this.findBordering(), updateCurrentCountry: this.props.updateCurrentCountry })
	      );
	    } else {
	      return React.createElement(
	        'h2',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RegionsSelect = React.createClass({
	  ...
	  createOption: function createOption(region, index) {
	    return React.createElement(
	      'option',
